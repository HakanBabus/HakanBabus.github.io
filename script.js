...
const translations = {
  tr: {
    ...
    hero_bio: "Ben <strong>Hakan Cineviz</strong> (<code>@HakanBabus</code>). BEUN'de Bilgisayar Mühendisliği okuyorum; pratik geliştirici araçları, yapay zekâ iş akışları ve oyun sunucuları için yazılımlar üretmeyi seviyorum.",
  ...
  en: {
    ...
    hero_bio: "I'm <strong>Hakan Cineviz</strong> (<code>@HakanBabus</code>), a Computer Engineering student at BEUN. I enjoy building practical developer tools, AI workflows, and software for game servers.",
